...
csi_predrnn_loss_atten = np.loadtxt(open(save_path+"202008260400to6_predrnn_loss_atten.csv","rb"), delimiter=",", skiprows=0)
csi_CREF = np.loadtxt(open(save_path+"202008260400to6_cref.csv","rb"), delimiter=",", skiprows=0)
...
csi_predrnn_atten = np.loadtxt(open(save_path+"202008260400to6_predrnn_atten.csv","rb"), delimiter=",", skiprows=0)
