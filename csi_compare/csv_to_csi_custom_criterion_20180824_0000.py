...
csi_predrnn_loss_atten = np.loadtxt(open(save_path+"201808240000to6_predrnn_loss_atten.csv","rb"), delimiter=",", skiprows=0)
csi_CREF = np.loadtxt(open(save_path+"201808240000to6_cref.csv","rb"), delimiter=",", skiprows=0)
...
fig.savefig(fname=save_path+'Thresholds_AVG_CSI_predrnn_convlstm.png', format='png')
plt.clf()
