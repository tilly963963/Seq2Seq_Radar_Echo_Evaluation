...
csi_predrnn_loss_atten = np.loadtxt(open(save_path+"202005220400to6_predrnn_loss_atten.csv","rb"), delimiter=",", skiprows=0)
csi_CREF = np.loadtxt(open(save_path+"202005220400to6_cref.csv","rb"), delimiter=",", skiprows=0)
# csi_MLC = np.loadtxt(open("MLC_{}/csi.csv","rb"), delimiter=",", skiprows=0)
csi_PredRNN = np.loadtxt(open(save_path+"202005220400to6_predrnn_loss_atten_v2.csv","rb"), delimiter=",", skiprows=0)
csi_PredRNN_loss = np.loadtxt(open(save_path+"202005220400to6_predrnn_loss.csv","rb"), delimiter=",", skiprows=0)
csi_predrnn_atten = np.loadtxt(open(save_path+"202005220400to6_predrnn_atten.csv","rb"), delimiter=",", skiprows=0)

csi_ConvLSTM = np.loadtxt(open(save_path+"202005220400to6_convlstm.csv","rb"), delimiter=",", skiprows=0)
csi_ConvLSTM_loss = np.loadtxt(open(save_path+"202005220400to6_convlstm_loss.csv","rb"), delimiter=",", skiprows=0)
...
fig.savefig(fname=save_path+'Thresholds_AVG_CSI_v3.png', format='png')
plt.clf()
